...
class UserTest_C113_sub_position_one extends TestCase
{
    /**
     ...
     * @return void
     */
    public function test_C113_sub_position_one()
    /* 
    #C113_set_masu_result.xmlファイル作成
    type nul > ./C113_sub_position_one_result.xml

    #UT実行 
    php artisan test --log-junit ./C113_sub_position_one_result.xml --filter test_C113_sub_position_one tests/Unit/UserTest_C113_sub_position_one.php
    */    {
        $masus[0] = '';
        $masus[1] = '-';
        $masus[2] = '';
        ...
        $player_position = $C113->sub_position_one($masus,$sk,$player_position);
        print_r("\n");
        print_r("input_data = ");
        print_r($masus);
        print_r("\n");
